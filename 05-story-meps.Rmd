...
```{r, cache=FALSE, out.width = "1400",fig.cap = "Ceters Paribus plot for feet_checked ", fig.align="center",echo=FALSE}
knitr::include_graphics('images/05-ct_feet_checked.PNG')
```

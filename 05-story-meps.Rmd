...
| `feet_checked`| -1 | -1 |
| `non-phys_visits`| 1 | 0 |
| `disposition`| 11-household | 11-household |
| `outpatient_visits`| 0 | 1 |
| `age`| 58 | 59 |
| `race`| 1 | 1 |
| `sex`| 2 | 1 |
| `edu`| 7-other | 4-bachelor's degree |
| `diab_disease`| 1 | 0 |
| `art_disease` | 1 | 1 |
| `ast_disease`| 0 | 1 |
| `press_disease` | 0 | 0 |
...
Model level exploration showed, that it is worth to study the influence of variables on each other. In our case, although the sex is practically insignificant, it has very much influenced the most important variable, almost twice.  
...
Perhaps, it would be worthwhile for financial institutions to make two-stage analysis to estimate final result. First is to estimate  the number of days spent in hospital or at home with illness based on demographic factors and medical history.The second is, to use of these results for further calculations. It could contribute to a more accurate assessment of the costs generated and be more beneficial for companies.  
